...
internal static class D2D1ShaderTestHelper
{
    ...
    /// <param name="transformFactory">The optional transform factory.</param>
        ...
        where T : unmanaged, ID2D1PixelShader
    {
        ...
        D2D1InteropServices.RegisterPixelShaderEffectForD2D1Factory1<T>(d2D1Factory2.Get(), transformFactory, out _);
